...
session_start();
  ...
  $bbs= " ". $_SESSION["bbseatallot"] ." ";
    ...
    $sql="SELECT * FROM payment p,register r,booking b WHERE p.r_id=r.r_id AND p.b_id=b.b_id AND r.r_id=$r_id ";
        ...
        <div class="body-section">
            <div class="row">
                <div class="col-6">
                    ...
                    <p class="sub-heading"><b>Bus Number:</b><?php echo "$busnum"; ?></p>
                </div>
                <div class="col-6">
